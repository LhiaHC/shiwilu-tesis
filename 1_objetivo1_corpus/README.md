...
python 1_objetivo1_corpus/pipeline/0_extraer_dominios.py
python 1_objetivo1_corpus/pipeline/1_generar_pares_anotados.py
python 1_objetivo1_corpus/pipeline/2_generar_oraciones.py
# ── paso manual de traducción ──
python 1_objetivo1_corpus/pipeline/3_consolidar_corpus.py
```
