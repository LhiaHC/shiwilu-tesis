...
Entrada: 1_objetivo1_corpus/intermedios/1_corpus_pares_anotados.xlsx
Salida:  1_objetivo1_corpus/intermedios/2_oraciones_para_traducir.xlsx
         1_objetivo1_corpus/intermedios/logs/2_oraciones_generadas_log.json
...
def leer_deficit() -> dict:
    if not PARES_ANOTADOS.exists():
        raise FileNotFoundError(
            ...
            "python 1_objetivo1_corpus/pipeline/1_generar_pares_anotados.py"
        )
