...
Entrada: 1_construccion_corpus/datos/II_TEXTOS_SHIWILU.pdf   (no versionado)
Salida:  1_construccion_corpus/intermedios/vocabulario_dominios.json
         1_construccion_corpus/intermedios/logs/vocabulario_dominios_log.json
